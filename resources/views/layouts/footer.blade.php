<footer id="footer" class="footer dark-background">
  ...
  <div class="container copyright text-center mt-4">
    <p>© {{ date('Y') }} <span>Copyright</span> <strong class="px-1 sitename"><span style="color: green;">Cactus</span><span style="color: blue;">NANO</span></strong> <span>All Rights Reserved</span></p>

          ...
          <ul>
            <li class="dropdown"><a href="{{ route('index.products') }}">Products <i class="bi bi-chevron-down toggle-dropdown"></i></a>
              <ul class="dropdown-menu" aria-labelledby="navbarDropdownProducts">         
                  ...
                  <li><a class="dropdown-item indented" style="padding-left: 1rem;" href="{{ url('/') }}/products/revolutionizing-ro-membrane-with-nano-technology" style="padding-left: 1rem;">CoreSil&trade; RO Membrane</a></li>

            ...
            <li class="nav-item dropdown user-menu">
                ...
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <li class="user-header bg-primary">
                        ...
                        <p>
                            {{ Auth::user()->name }}
                            <small>Joined: {{ Auth::user()->created_at->format('F Y') }}</small>
                        </p>
                    </li>
                    <!-- Menu Footer-->
...
@if(Request::is('dashboard/products') || Request::is('dashboard/products/*') || Request::is('dashboard/markets') || Request::is('dashboard/markets/*') || Request::is('dashboard/teams') || Request::is('dashboard/teams/*') || Request::is('dashboard/news') || Request::is('dashboard/news/*') || Request::is('dashboard/events') || Request::is('dashboard/success-stories') || Request::is('dashboard/success-stories'))

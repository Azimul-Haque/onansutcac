...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-3">
              <a href="{{ route('dashboard.teams') }}" class="info-box mb-3">
          ...
          <div class="col-md-3">
              <a href="{{ route('dashboard.get-about-data') }}" class="info-box mb-3">
          ...
          <div class="col-md-3">
              <a href="{{ route('dashboard.help-center') }}" class="info-box mb-3">

    ...
    <div class="row">
      <div class="col-md-12 col-12">
        ...
        <p>
		  ...
		  to it, still belong to <b>Unisoft 360</b>.
		</p>
		<br/>
		<p>
		  <b>Unisoft 360</b> is committed to ensuring that the app is
		...
		<br/>
		<p>
		  The <strong>Infoline - BD Smart Seba</strong> app stores and processes personal data that
		  ...
		  that the <strong>Infoline - BD Smart Seba</strong> app won’t work properly or at all.
		</p>
		<br/>
		<div>
		<p>
		...
		<p>
		  ...
		  <b>Unisoft 360</b> will not take responsibility for. Certain
		  functions of the app will require the app to have an active
		  internet connection. The connection can be Wi-Fi or provided
		  by your mobile network provider, but <b>Unisoft 360</b>
		...
		<br/>
		<p>
		  Along the same lines, <b>Unisoft 360</b> cannot always take
		  responsibility for the way you use the app i.e. You need to
		  make sure that your device stays charged – if it runs out of
		  battery and you can’t turn it on to avail the Service,
		  <b>Unisoft 360</b> cannot accept responsibility.
		</p>
		<br/>
		<p>
		  With respect to <b>Unisoft 360</b>’s responsibility for your
		  use of the app, when you’re using the app, it’s important to
		  bear in mind that although we endeavor to ensure that it is
		  updated and correct at all times, we do rely on third parties
		  to provide information to us so that we can make it available
		  to you. <b>Unisoft 360</b> accepts no liability for any
		...
		<p>
		  ...
		  using the app. <b>Unisoft 360</b> does not promise that it

    ...
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide">
        <div class="testimonial-item">
          <img src="{{ asset('vendor/dewi/assets/img/testimonials/testimonials-1.jpg') }}" class="testimonial-img" alt="Saul Goodman">
          <h3>Saul Goodman</h3>
          <h4>CEO &amp; Founder</h4>
          <div class="stars">
      ...
      <div class="swiper-slide">
        <div class="testimonial-item">
          <img src="{{ asset('vendor/dewi/assets/img/testimonials/testimonials-2.jpg') }}" class="testimonial-img" alt="Sara Wilsson">
          <h3>Sara Wilsson</h3>
          <h4>Designer</h4>
          <div class="stars">
            <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
      ...
      <div class="swiper-slide">
        <div class="testimonial-item">
          <img src="{{ asset('vendor/dewi/assets/img/testimonials/testimonials-3.jpg') }}" class="testimonial-img" alt="Jena Karlis">
          <h3>Jena Karlis</h3>
          <h4>Store Owner</h4>
          <div class="stars">
            <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
      ...
      <div class="swiper-slide">
        <div class="testimonial-item">
          <img src="{{ asset('vendor/dewi/assets/img/testimonials/testimonials-4.jpg') }}" class="testimonial-img" alt="Matt Brandon">
          <h3>Matt Brandon</h3>
          <h4>Freelancer</h4>
          <div class="stars">
            <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
      ...
      <div class="swiper-slide">
        <div class="testimonial-item">
          <img src="{{ asset('vendor/dewi/assets/img/testimonials/testimonials-5.jpg') }}" class="testimonial-img" alt="John Larson">
          <h3>John Larson</h3>
          <h4>Entrepreneur</h4>
          <div class="stars">
            <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>

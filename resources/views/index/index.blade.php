...
@section('content')
    ...
    <section id="clients" class="recent-news section light-background">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="text-center mt-5">
          <a href="#!" style="display: inline-block; margin-top: 15px; background-color: #205ed7; padding: 10px 20px; color: white; border-radius: 25px; font-weight: 600; text-transform: uppercase; font-size: 14px;">View All News</a>
        </div>

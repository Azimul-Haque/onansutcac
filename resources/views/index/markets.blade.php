...
@section('content')
    ...
    <div class="page-title dark-background" data-aos="fade" style="background-image: url('https://i.makeagif.com/media/3-19-2019/pC3moX.gif');">
          ...
          <div class="col-md-6 aos-init" data-aos="fade-right" data-aos-delay="100">
            <div class="service-item">
              ...
              <div class="service-content">
                ...
                <a href="{{ route('index.singlemarket') }}" class="service-link">
